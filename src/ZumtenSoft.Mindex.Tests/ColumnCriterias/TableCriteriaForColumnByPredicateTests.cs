...
namespace ZumtenSoft.Mindex.Tests.ColumnCriterias
{
    ...
    public class TableCriteriaForColumnByPredicateTests
    {
        ...
        public void BuildCondition_WhenFilteringWithPredicate_ShouldApplyThisPredicate()
        {
            ...
            TableColumnByPredicate<SiteRanking, SiteRankingSearch, char> column = new TableColumnByPredicate<SiteRanking, SiteRankingSearch, char>(s => s.TLDContainsChar, (r, c) => containsLetter(r.TopLevelDomain, c), false);
            var criteria = column.ExtractCriteria(new SiteRankingSearch { TLDContainsChar = new [] { 'c', 'o' } });
